    ...
    public class EventSqlDalTests
    {
        ...
        public void Initialize()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                command = new SqlCommand("INSERT INTO Event(beginning, ending, coverPhoto, descriptionCopy, ticketLevel, upsaleCopy, isFinalized, eventName)" +
                    "VALUES ('11 / 15 / 2016 03: 39 pm', '4 / 10 / 2019 10: 39 pm', 'catCount@johnfoulton.com', 'Enter Copy Here', 'dogCount@johnfoulton.com', 'VIP', 'All the cool kids are doing it!', 1, 'Pet Count = 17'); SELECT CAST(SCOPE_IDENTITY() as int);", connection);
